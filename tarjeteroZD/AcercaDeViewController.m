...
//  tarjeteroZD
//
//  Created by Oscar Zarco on 26/05/15.
...
- (IBAction)paginaWebButtonPress:(UIButton *)sender {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"http://www.zarcodev.com"]];
}
@end
